    ...
    $scope.GetAddress = function () {
        ...
        if (navigator.geolocation) {
            ...
            navigator.geolocation.getCurrentPosition(function (p) {
                ...
                blockUI.start('Fetching Location');
...
app.controller('cook_register', ['$scope', '$http', '$location', '$cookieStore', '$timeout', '$base64', '$window', '$rootScope', 'cfpLoadingBar', 'Notification', '$localStorage', 'blockUI', function ($scope, $http, $location, $cookieStore, $timeout, $base64, $window, $rootScope, cfpLoadingBar, Notification, $localStorage, blockUI) {
    ...
    $scope.save_food_details = function (save_food_details) {
        ...
        $timeout(function () {
            ...
            if (!$scope.u.available_hours.hasOwnProperty('mon_to')) {
            ...
            if (!$scope.u.available_hours.hasOwnProperty('tue_to')) {
            ...
            if (!$scope.u.available_hours.hasOwnProperty('wed_to')) {
...
app.controller('user_register', ['$scope', '$http', '$location', '$cookieStore', '$timeout', '$routeParams', '$base64', '$rootScope', 'cfpLoadingBar', 'Notification', '$route', '$localStorage', 'blockUI', function ($scope, $http, $location, $cookieStore, $timeout, $routeParams, $base64, $rootScope, cfpLoadingBar, Notification, $route, $localStorage, blockUI) {
                ...
                navigator.geolocation.getCurrentPosition(function (p) {
                    ...
                    for (var i = 0; i < $localStorage.lat_long_coll.length; i++) {
                        ...
                        markerB = new google.maps.Marker({
                            ...
                            map: map,
                            icon: 'http://192.168.1.6:3000/uploads/q.png'
                        });
    ...
    $scope.checkout_timepicker = function (id) {
        console.log(id);    
